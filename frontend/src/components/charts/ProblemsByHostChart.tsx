...
const ProblemsByHostChart: React.FC<ProblemsByHostChartProps> = ({ data }) => {
  const options: ApexOptions = {
    ...
    yaxis: {
      labels: { style: { colors: '#475569', fontWeight: 500, fontSize: '14px' } },
    },
    grid: {
      borderColor: '#F1F5F9',
      strokeDashArray: 4,
  ...
  return (
    ...
    >
      <h3 className="text-[18px] font-semibold text-[#0F172A] mb-1">Top Problematic Hosts</h3>
      <p className="text-[15px] text-[#94A3B8] mb-4">Hosts with most active problems</p>
      <div className="h-72">
